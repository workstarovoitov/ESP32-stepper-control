...
#define CONTROL_SW_DEBOUNCE_PERIOD 64  // in milliseconds default 32 microseconds
...
const int DEBOUNCE_PERIOD = 64;  // in milliseconds default 32 microseconds
